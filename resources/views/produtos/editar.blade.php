...
<div class="columns">
      ...
      <form action="/produtos/editar/{{$produto->id}}" method="post" >
        ...
        <div class="field">
            ...
            <div class="control">
              <input class="input" type="text" value="{{$produto->imageURL}}" placeholder="Cole a URL da imagem" name="imageURL">
            </div>
          </div>
        <div class="field">
          <label class="label">Preço</label>
          <div class="control">
          <input class="input" type="text" name="preco" value="{{$produto->preco}}" placeholder="Digite o preço do produto">
          </div>
        </div>
        <hr>
